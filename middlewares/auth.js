...
exports.protect = async (req,res,next) => {
    ...
    // else if (req.cookies.token ) { //* req.cookies ile cookie' ye erişebiliyorum. Sondaki .token benim authcontroller'da verdiğim string, zurna deseydim burda zurna yazacaktık.
